...
const store = createStore({
  state() {
    return {
      ...
      // base_url: 'http://localhost:8083/beta',
      payment_id: sessionStorage.getItem('payment_id') || null,
       base_url: 'https://aksharammuseum.com/beta',
       publicPath: '/beta/',
      ctg: [],
      ...
      session: JSON.parse(sessionStorage.getItem('session')) || true,
      ...
      categoryTypes: JSON.parse(sessionStorage.getItem('categoryTypes')) || [],
      categoryPrices: JSON.parse(sessionStorage.getItem('categoryPrices')) || [],
      categoryId: sessionStorage.getItem('categoryId') || null
    };
  },
